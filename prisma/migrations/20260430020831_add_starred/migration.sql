...
INSERT INTO "new_Note" ("content", "createdAt", "folderId", "id", "pinned", "projectId", "title", "updatedAt") SELECT "content", "createdAt", "folderId", "id", "pinned", "projectId", "title", "updatedAt" FROM "Note";
DROP TABLE "Note";
